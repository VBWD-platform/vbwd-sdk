...
**Status:** 🟢 DONE on disk, gates green — BE (S67.1 ≡ S66) 2026-06-11 ([report 05](../../20260611/reports/05-s66-s67-1-backend-apns-push.md)) · iOS (S67.2) 2026-06-12 ([report 06](../../20260611/reports/06-s67-2-ios-notifications-and-badges.md)); not committed. Real-device APNs end-to-end proof pending (needs physical device + signing). One feature, two repos. **Engineering requirements (BINDING):** TDD-first · DevOps-first · SOLID · DI · DRY · Liskov · clean code · NO OVERENGINEERING — [`_engineering-requirements.md`](../../20260525/sprints/_engineering-requirements.md).
